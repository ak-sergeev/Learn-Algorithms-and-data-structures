...
def binary_search_rec(array, value, min_index=0, max_index=None):
    ...
    Если в массиве более одного искомого элемента, то функция возвращает его последнее вхождение.
    Если элемента в массиве нет, то возвращет -1.
    """
    ...
    if max_index >= min_index:
        ...
        # Условие выхода из рекурсии - последний элемент среди искомых.
        if (middle_index == len(array) - 1 or value < array[middle_index + 1]) and array[middle_index] == value:
            return middle_index
